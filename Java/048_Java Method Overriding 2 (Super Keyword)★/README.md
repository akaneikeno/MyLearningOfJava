# Java Method Overriding 2 (Super Keyword) - level: Easy, language: Java
> Java Method Overriding 2 (Super Keyword) in Hackerrank (https://www.hackerrank.com/challenges/java-datatypes/problem).
