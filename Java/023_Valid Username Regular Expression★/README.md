# Valid Username Regular Expression - level: Easy, language: Java
> Valid Username Regular Expression in Hackerrank (https://www.hackerrank.com/challenges/java-datatypes/problem).
