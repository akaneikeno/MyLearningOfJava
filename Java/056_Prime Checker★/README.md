# Prime Checker - level: Medium, language: Java - level: Easy, language: Java
> Prime Checker in Hackerrank (https://www.hackerrank.com/challenges/java-datatypes/problem).
